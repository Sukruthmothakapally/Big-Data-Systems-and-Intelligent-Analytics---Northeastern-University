...
def get_top_tags_data(bq_client):
    top_tags_query = """
...
def insert_data_into_posts_table(bq_client, top_tags):
    query = f"""
...
if __name__ == "__main__":
    ...
    top_tags = get_top_tags_data(bq_client)
    insert_data_into_posts_table(bq_client, top_tags)
